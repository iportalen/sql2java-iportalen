//$Id: UserCodeParser.java,v 1.2 2006-01-26 13:10:04 fbr Exp $
 ...
 * @version $Id: UserCodeParser.java,v 1.2 2006-01-26 13:10:04 fbr Exp $
 */
public class UserCodeParser {
    ...
    private Map<String, String> codeHash;
    ...
    public void parse(String filename) throws Exception {
        codeHash = new Hashtable<String, String>();
        ...
        if(file.exists()) {
            ...
            while(line != null) {
                ...
                if(line.indexOf(START) != -1) {
                    if(inBlock) {
                        if(line.indexOf(START + blockName + BLOCK_END) != -1) {
    ...
    public String[] getBlockNames() {
        ...
        int i = 0;
        for(String blockCode : codeHash.keySet()) {
            list[i++] = blockCode;
        }
